...
function Library:Create(table)
    ...
    function tabHandler:Tab(name, iconId)
        ...
        function ElementHandler:Slider(text, default, min, max, callback)
            ...
            textLabel1.Size = UDim2.fromOffset(150, 35)
            ...
            textLabel2.Position = UDim2.fromOffset(170, 0)
            ...
            frame.Position = UDim2.fromOffset(220, 12)
            frame.Size = UDim2.fromOffset(110, 10)
            frame.Parent = slider
            ...
            frame1.Size = UDim2.fromOffset(((default - min) / (max - min)) * 110, 10)
            frame1.Parent = frame
            ...
            UserInputService.InputChanged:Connect(function(input)
                if dragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
                    ...
                    frame1.Size = UDim2.fromOffset(percentage * 110, 10)
        ...
        function ElementHandler:Paragraph(titleText, descriptionText)
            titleText = titleText or "Title"
            descriptionText = descriptionText or "Description"
            ...
            paragraph.BackgroundColor3 = theme.ElementBackground
            paragraph.BackgroundTransparency = 0
            paragraph.Position = UDim2.fromOffset(0, 0)
            paragraph.Size = UDim2.fromOffset(340, 0)
            ...
            titleLabel.Size = UDim2.fromOffset(320, 21)
            ...
            descLabel.Size = UDim2.fromOffset(320, 0)
            descLabel.Parent = paragraph

            local titleHeight = 21
            local descHeight = descLabel.TextBounds.Y
            paragraph.Size = UDim2.fromOffset(340, titleHeight + descHeight + 10)

            local paragraphHandler = {}

            function paragraphHandler:Update(newTitle, newDesc)
                newTitle = newTitle or titleLabel.Text
                newDesc = newDesc or descLabel.Text
                titleLabel.Text = newTitle
                descLabel.Text = newDesc
                descHeight = descLabel.TextBounds.Y
                paragraph.Size = UDim2.fromOffset(340, titleHeight + descHeight + 10)
                updateCanvasSize()
            end
